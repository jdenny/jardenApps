...
public class BookHand {
    private static final BookHand page23 = new BookHand(
            "page23",
            new Hand(new CardPack.CardEnum[] { // 23pp, 15-1+0+1HCP/+0, 3-4-2-4
                    CQ, CJ, C5, DA, DQ, D8, D5, H9, H3, SK, SQ, SJ, S2 }),
            new Hand(new CardPack.CardEnum[] { // 22pp, 13+0+0+0HCP/+0, 3-3-6-1
                    CK, C8, C2, DK, D7, D6, HA, HK, H8, H6, H5, H2, S6 }),
    ...
    public static final BookHand edwards1 = new BookHand(
            ...
            new int[] {30, 20, 23, 16});
    public static final BookHand edwards2 = new BookHand(
            "edwards2",
            new Hand(new CardPack.CardEnum[] { // 30pp, 19+1+0+1HCP/+0, 2-2-5-4
                    CA, C8, DA, D5, HA, HQ, H7, H5, H4, SA, SJ, ST, S9 }),
            new Hand(new CardPack.CardEnum[] { // 23pp, 16-1-1+0HCP/+0, 5-4-2-2
                    CK, CJ, C9, C3, C2, DK, DQ, D8, D4, HK, HJ, SK, S6 }),
            "1C, 2D; 2H, 3C; 3NT, 4NT; 6NT, Pass",
            "1D, 1H; 2C, 6NT; Pass",
            new int[] {30, 23, 21, 14});
